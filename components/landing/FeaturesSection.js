      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Tout ce dont vous avez besoin pour gérer vos APIs efficacement
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Sécurité avancée</h3>
            <p className="text-gray-600">
              Authentification robuste avec Clerk, chiffrement des clés API et protection des routes.
            </p>
          </div>
          ...
          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-green-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Validation en temps réel</h3>
            <p className="text-gray-600">
              Testez et validez vos clés API instantanément avec notre playground intégré.
            </p>
          </div>
          ...
          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-purple-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Analytics détaillées</h3>
            <p className="text-gray-600">
              Suivez l&apos;utilisation, les performances et les coûts de vos APIs.
            </p>
          </div>
          ...
          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-orange-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Gestion des abonnements</h3>
            <p className="text-gray-600">
              Plans flexibles avec mode pay-as-you-go et suivi des crédits.
            </p>
          </div>

          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Interface intuitive</h3>
            <p className="text-gray-600">
              Dashboard moderne et responsive pour une expérience utilisateur optimale.
            </p>
          </div>

          <div className="group p-8 rounded-2xl border border-gray-100 hover:border-teal-200 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">API REST complète</h3>
            <p className="text-gray-600">
              Endpoints robustes pour intégrer Dominium dans vos applications.
            </p>
          </div>
        </div>
      </div>
